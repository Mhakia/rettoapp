...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'address' => 'dirección',
        'phone' => 'teléfono',
        'bulletin_frequency' => 'frecuencia de boletines',
        'country' => 'país',
        'state' => 'departamento o estado',
        'city' => 'ciudad',
        'entity_type' => 'tipo de entidad educativa',
        'contact_first_name' => 'nombre del contacto',
        'contact_middle_name' => 'segundo nombre del contacto',
        'contact_last_name' => 'apellido del contacto',
        'contact_second_last_name' => 'segundo apellido del contacto',
        'contact_document_type' => 'tipo de documento del contacto',
        'contact_document_number' => 'número de documento del contacto',
        'contact_email' => 'correo de contacto',
        'contact_phone' => 'celular de contacto',
        'principal_name' => 'nombre del rector o director',
        'principal_document_type' => 'tipo de documento del rector o director',
        'principal_document_number' => 'número de documento del rector o director',
        'principal_started_at' => 'fecha de ingreso del rector o director',
