...
class InstitutionAdminAccountCreated extends Notification
{
    /**
    ...
    public function toMail(User $notifiable): MailMessage
    {
        ...
        return (new MailMessage)
            ...
            ->line(__('Se creó tu cuenta de administrador para :institution en :app.', [
                'institution' => $notifiable->institution?->name,
                'app' => config('app.name'),
            ]))
